...
$('.extension-checkbox').change(function(event){
	...
	if($(this).is(':checked')) {
		$('#settings-ext-list').append('<div class="settings-extensions" data-extension="'+ext+'"><label><input type="checkbox" name="epm|settings[]" value="'+ext+'" checked> '+name+' &lt;'+ext+'&gt;</label><br /></div>');
	} else {
...
<table>
	<tr class="guielToggle" data-toggle_class="EPM">
		<td colspan="2" ><h4><span class="guielToggleBut">-  </span><?php echo _("Endpoint")?></h4><hr></td>
	</tr>
	<tr>
		<td colspan="2">
			<div class="indent-div">
				<table>
					<tr class="UCP">
						<td><?php echo _('a;lkdsjfa;lskdfjlfkjasdl;fkjasdf;lkjasdfAllow Login')?></td>
						<td>
							<span class="radioset">
