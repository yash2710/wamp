			...
			<tr class="account_summary_section">
				...
				<td>
					<table width="100%">
						...
						<tr>
							<td>
								<small><b><?php echo _("International Calling") ?>:&nbsp;</b><?php echo !empty($server_settings['international']) ? _('Yes') : _('No') ?></small>
							</td>
						</tr>
						<tr>
							<td>
								<small><b><?php echo _("Outbound Fax") ?>:&nbsp;</b><?php echo !empty($server_settings['fax']) ? _('Yes') : _('No') ?></small>
							</td>
						</tr>
						<tr>
							<td>
								<small><b><?php echo _("SMS Support") ?>:&nbsp;</b><?php echo !empty($server_settings['sms']) ? _('Yes') : _('No') ?></small>
							</td>
						</tr>
					</table>
				</td>
